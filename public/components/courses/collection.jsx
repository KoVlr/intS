...
export default function Collection() {
    const [courses, setCourses, scrollHandler, activateLoad] = useInfiniteScroll(fetch_collection);
    ...
    return (
        <div>
            ...
            {!search_mode
                ...
                : <SearchInCourses key={query} query={query} mine={false} collection={true}/>
            }
        </div>
    );
}